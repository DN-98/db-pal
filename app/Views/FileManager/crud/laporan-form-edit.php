    ...
    <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            <form method="POST" data-single="false" data-file-types="image/jpeg|image/png|image/jpg" action="<?= base_url() ?>/file-manager/upload_image_laporan" class="dropzone border-gray-200 border-dashed" >
                <input type="text" hidden name="id_laporan" value="<?= $_GET['id'] ?>">
            ...
            <hr>
            <form method="POST" action="<?= base_url() ?>/file-manager/laporan-edit/proses-edit-laporan">
                <input type="text" hidden name="id_laporan" value="<?= $_GET['id'] ?>">
                <div>
                    <label>Judul Laporan</label>
                    <input type="text" class="input w-full border mt-2" placeholder="Input text" name="judul_laporan" value="<?= $data->judul_laporan; ?>">
                </div>
                <div>
                    <label>Detail Laporan</label>
                    <textarea class="input w-full border mt-2" name="detail_laporan"><?= $data->detail_laporan; ?></textarea>
                </div>
